...
const Footer = () => {
  ...
  return (
    <>
      <div className="px-5 py-10 xl:px-20 xl:pt-20 bg-gradient-to-b from-[#f4f4f4] to-[#ee9ca7] relative">
        <div className="flex flex-col gap-10 lg:flex-row justify-between">
          <div className="lg:w-1/3 text-center lg:text-left">
            <h1 className="text-3xl font-musky lg:pl-5 drop-shadow-md">
              Parakh
            </h1>
            <h1 className="text-lg tracking-wider font-Pacifico text-[#f2707f]">
              Let's find the best
            </h1>
          ...
          <div className="lg:w-1/4 xl:w-1/3 text-center lg:text-left mt-10 lg:mt-0">
